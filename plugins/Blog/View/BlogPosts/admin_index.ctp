...
<!--    </td>-->
    <td>
        <?php echo $this->Html->link('', array('action' => 'edit', $blogPost['BlogPost']['id']), array('escape' => false, 'class' => 'actions', 'data-icon' => '&#xF139;')); ?>
    </td>
    <td>
        <?php echo $this->Form->postLink('<span data-icon="&#xF155;"></span>', array('action' => 'delete', $blogPost['BlogPost']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $blogPost['BlogPost']['id'])); ?>
    </td>
</tr>
<?php endforeach; ?>
</table>
